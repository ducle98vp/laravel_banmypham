        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content">
                            <p class="footer-des">DL STORE là cửa hàng số 1 Việt Nam vê mỹ phẩm online an toàn và giá rẻ</p>
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        <div class="snap-footer-title">
                            <h4>Mua Sắm cùng chúng tôi</h4>
                        </div>
                        <div class="cakewalk-footer-content">
                            <ul>
                                <li><a href="shop-grid.html">Tạo Kiểu Tóc</a></li>
                                <li><a href="shop-grid.html">Chăm Sóc Tóc</a></li>
                                <li><a href="shop-grid.html">Chăm Sóc Râu</a></li>
                ...
                <div class="col-md-2 hidden-sm">
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content social-footer">
                            <ul>
                                <li><a href="https://www.facebook.com/ducleevp.98" target="_blank"><i class="fa fa-facebook"></i></a><span> Facebook</span></li>
